...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly objects
     * This constructor takes in two strings as arguments.
     *
     * @param firstString the first string that acts as the first part of the Silly instance's name
     * @param secondString the second string that acts as the second part of the Silly instance's name
     */
    ...
    public static void main(String[] args) {
        ...
        x.countStatic();
        x.countStatic();
        int[] expected_values = {my_static-4, my_static - 3, my_static - 2, my_static -1};
